groups.send_videos = async function () {
    groups_Groups.sending[1].style.visibility = "hidden";
    ...
    xhr.onreadystatechange = function() {
        if(xhr.readyState == 4 && xhr.status == 200) {
            ...
            this.previous[this.current].conversation.appendChild(create_video("sent", "", "", "data/this/group_between_" + this.responseText, Common.w, Common.h));
