...
export function setCookie(cookieKey, cookieValue, expireDays) {
	const date = new Date()
...
export function create_image(class_name, id, oc, src, w, h) {
...
export function create_video(class_name, id, oc, src, w, h) {
