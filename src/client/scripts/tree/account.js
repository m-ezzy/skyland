...
export default class Account extends Content {   //settings //accounts
    ...
    super.initialize()
		...
		this.e.i['icon'] = this.e.content.getElementsByClassName('image icon icon-users')[0]
		this.e.f['icon'] = this.e.content.getElementsByClassName('file pp')[0]
		this.e.b['icon'] = this.e.content.getElementsByClassName('button pp')[0]
  }
	load = load
