...
callsRouter.post("/update_call_length/chats", callsController.update_call_length_chats)
callsRouter.post("/update_call_length/groups", callsController.update_call_length_groups)
