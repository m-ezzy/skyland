...
// import item_hero from '../prev/item_hero'
...
export default class Common extends Content {
  constructor(number, name) {
	...
	initialize() {
		...
		this.e['l']['media'] = this.e.content.getElementsByClassName('list media')[0]
		...
		this.e['t']['search'] = this.e.content.getElementsByClassName('textbox search')[0]
