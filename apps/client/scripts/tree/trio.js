...
import handle_click_create_menu from '../conv/1_groups_channels/handle_click_create_menu'
...
import handle_click_files from '../conv/media/handle_click_files'
...
import handle_focus_tb_message from '../conv/media/handle_focus_tb_message'
import handle_blur_tb_message from '../conv/media/handle_blur_tb_message'
import handle_keyup from '../conv/media/handle_keyup'
...
export default class Trio extends Common {
	...
	initialize() {
		...
		this.e['mu'] = this.e.content.getElementsByClassName('media_upload')[0]
		...
		this.e['t']['msg'] = this.e.content.getElementsByClassName('textbox textbox_message')[0]
  ...
  handle_input_search = handle_input_search.bind(this)
	...
	handle_click_create_menu = handle_click_create_menu
	...
	handle_click_files = handle_click_files
	handle_change_files = handle_change_files
	handle_click_location = handle_click_location
	handle_focus_tb_message = handle_focus_tb_message
	handle_blur_tb_message = handle_blur_tb_message
